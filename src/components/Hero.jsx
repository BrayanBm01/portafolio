...
export const Hero = () => {
  return (
    <section className="relative bg-gradient-to-br from-purple-800 via-purple-700 to-purple-900 text-white py-29 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 flex flex-col items-center md:items-start text-center md:text-left relative z-10">
        ...
        <motion.p
          ...
          className="text-yellow-400 font-semibold text-xs sm:text-sm md:text-base tracking-[0.2em] uppercase mb-4"
        >
          Impulsa tu marca
        </motion.p>
        ...
        <motion.h1
          ...
          className="text-3xl sm:text-4xl md:text-6xl font-extrabold leading-snug md:leading-tight mb-6 drop-shadow-lg"
        >
        ...
        <motion.p
          ...
          className="text-sm sm:text-base md:text-lg text-gray-200 mb-8 max-w-2xl leading-relaxed"
        >
        ...
        <motion.ul
          ...
          className="mb-10 space-y-3 sm:space-y-4 w-full max-w-md text-left text-sm sm:text-base"
        >
